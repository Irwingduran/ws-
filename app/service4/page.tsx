...
const Page = () => {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative bg-[#3B5998]/20 bg-blend-overlay" style={{ backgroundImage: "url('/service/img1.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3B5998] text-center mb-8">Our Gastric Sleeve Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="bg-[#F5F7FA] p-8 rounded-lg shadow-md">
                <h3 className="text-2xl font-bold text-[#3B5998] mb-4">What is Gastric Sleeve Surgery?</h3>
