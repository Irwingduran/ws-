  ...
  return (
    <div className="flex flex-col min-h-screen">
     <Navbar/>
      ...
      {/* Hero Section */}
      <section className="relative bg-[#3B5998]/20 bg-blend-overlay" style={{ backgroundImage: "url('/service/img3.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3B5998] text-center mb-8">Our Breast Augmentation Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="bg-[#F5F7FA] p-8 rounded-lg shadow-md">
                <h3 className="text-2xl font-bold text-[#3B5998] mb-4">What is Breast Augmentation?</h3>
              ...
              {/* Procedure Steps */}
              <div className="bg-[#F5F7FA] p-8 rounded-lg shadow-md">
                <h3 className="text-2xl font-bold text-[#3B5998] mb-4">The Procedure</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-[#4A90E2] text-white rounded-full flex items-center justify-center">1</div>
                    <div>
                      <h4 className="font-semibold text-[#3B5998]">Consultation</h4>
                      <p className="text-gray-600">We discuss your goals and recommend the best approach.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-[#4A90E2] text-white rounded-full flex items-center justify-center">2</div>
                    <div>
                      <h4 className="font-semibold text-[#3B5998]">Surgery</h4>
                      <p className="text-gray-600">Performed under anesthesia, ensuring a comfortable experience.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-[#4A90E2] text-white rounded-full flex items-center justify-center">3</div>
                    <div>
                      <h4 className="font-semibold text-[#3B5998]">Recovery</h4>
            ...
            <div className="space-y-8">
              {/* Benefits */}
              <div className="bg-[#F5F7FA] p-8 rounded-lg shadow-md">
                <h3 className="text-2xl font-bold text-[#3B5998] mb-4">Why Choose Us?</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-[#4A90E2] text-white rounded-full flex items-center justify-center">✓</div>
                    <div>
                      <h4 className="font-semibold text-[#3B5998]">Expert Surgeons</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-[#4A90E2] text-white rounded-full flex items-center justify-center">✓</div>
                    <div>
                      <h4 className="font-semibold text-[#3B5998]">Personalized Care</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-[#4A90E2] text-white rounded-full flex items-center justify-center">✓</div>
                    <div>
                      <h4 className="font-semibold text-[#3B5998]">State-of-the-Art Facility</h4>
